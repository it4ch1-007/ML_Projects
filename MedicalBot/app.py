...
# Getting the symptoms of the User
...
#store the symptoms at a route the '/symptom' page
        ...
        if not user_symptoms:
            ...
            for each in symptoms_list: 
                if each in user_symptoms:
                    ...
                    x_test.append(0)
#Using numpy to get the test stored as numpy array
...
#json encoding for the sentence response
